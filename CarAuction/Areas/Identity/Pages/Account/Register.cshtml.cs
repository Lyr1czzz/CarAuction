        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var callbackUrl = Url.Page(nameof(ConfirmEmail),
                        "Account",
                        values: new { area = "Identity", token, userId = userId },
                        protocol: Request.Scheme);

                    await _emailSender.SendEmailAsync(Input.Email, callbackUrl, token);
